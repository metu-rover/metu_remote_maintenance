...
# TASK 2 specific functions
  def t2_spawn_imu(self):
      ...
      imu_pose.pose.position.z = imu_marker_pose.transform.translation.z - 0.03
  ...
  def approach_imu(self):
    ...
    pose_goal.position.z = marker_pose.transform.translation.z + 0.13
  ...
  def t2_put_on_panel(self, button_id):

    rospy.loginfo("Getting close to marker with id %s", button_id)
    move_group = self.move_group
    marker_pose = self.marker_poses[button_id]
    
    pose_goal = geometry_msgs.msg.Pose() 
   
    pose_goal.position.x = marker_pose.transform.translation.x - 0.12
    pose_goal.position.y = marker_pose.transform.translation.y - 0.15
    pose_goal.position.z = marker_pose.transform.translation.z - 0.12
