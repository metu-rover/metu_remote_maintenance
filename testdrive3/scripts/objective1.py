...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("scanning middle panel")
        ur3_arm.t1_scan_middle_panel()
	
        rospy.loginfo("writing recorded aruco poses to markers.csv")	
        ...
        rospy.loginfo("writing recorded aruco poses to markers_precise.csv")
        ...
        rospy.loginfo ("objective 1 Completed !")
        rospy.sleep(0.01)
